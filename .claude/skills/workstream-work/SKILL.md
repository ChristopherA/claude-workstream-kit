...
Before working a task that was migrated or inherited from another workstream (carried across a closure, or copied in from an older backlog), verify its description against live reality first — the named files and artifacts, not the backlog's wording. Migrated descriptions are dated snapshots: the work may be partly or wholly done, or scoped against a state that no longer exists, and working one blind redoes or over-scopes it. This is the working-side analogue of review's "verify a Learning against the named file".
